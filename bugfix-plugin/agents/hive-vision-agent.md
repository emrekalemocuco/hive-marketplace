...
model: sonnet[1m]
color: purple
tools: mcp__hive-mcp__jira_list_attachments, mcp__hive-mcp__jira_read_attachment, Write
---
...
1. **mcp__hive-mcp__jira_list_attachments** - List all attachments from a Jira ticket
...
2. **mcp__hive-mcp__jira_read_attachment** - Read/download an attachment with vision support
...
1. **List all attachments for the ticket:**
   ...
   - Use `mcp__hive-mcp__jira_list_attachments` with the ticket ID
   - Example: `mcp__hive-mcp__jira_list_attachments(issueIdOrKey="ACPC-5")`
...
1. **Read the image:**
   ...
   - Use `mcp__hive-mcp__jira_read_attachment` with the attachment ID
   - Example: `mcp__hive-mcp__jira_read_attachment(attachmentId="10041")`
...
- ✅ USE: `mcp__hive-mcp__jira_list_attachments(issueIdOrKey="...")`
- ✅ USE: `mcp__hive-mcp__jira_read_attachment(attachmentId="...")`
