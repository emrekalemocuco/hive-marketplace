...
export async function handleJiraGetIssue(args) {
    try {
...
export async function handleJiraGetComments(args) {
    try {
...
export const jiraAddCommentTool = {
...
export async function handleJiraAddComment(args) {
    try {
...
export const jiraListAttachmentsTool = {
...
export async function handleJiraListAttachments(args) {
    try {
        const { issueKey } = args;
...
export const jiraReadAttachmentTool = {
...
export async function handleJiraReadAttachment(args) {
    try {
